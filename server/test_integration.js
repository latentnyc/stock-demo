...
const BASE_URL = 'http://localhost:3001/api/proxy';
...
async function runTests() {
    ...
    await testEndpoint('company-news', { symbol: 'AAPL', from: '2023-01-01', to: '2023-01-10' }); // dates ignored by my script for now but good to pass
